...
### Description
1. Books: 
   This is the central page of our software, in which user could select the vocabulary books that they want to learn by cliking the "+" bottom in the lower right place of the page. Here we already have four vocabulary books all set. And user could input the books that they wish to work on. Till now, only csv. files are allowed to be imported with words on column one, explanations on column two and example sentences on colume three. 
   
   <img src = "https://github.com/Tesla-SHT/TOEFL-Modder/assets/109467147/c21dcea2-adfb-428a-8d69-9c9545af3301" alt = "Books" width="50%">
   
   And the click action on each book would directs to the reciting page of each vocabulary. In which users would select the explanation of the word and get response. Also, there had two more functions including adding the word into user's own collection list (which could be further accessed in the Progress page) and removing the word away from the whole book.
...
2. Progress: Display the learning data and some analysis:
   ...
   Here you could see the progress that you made after you meet our software, including the days you spend on each books, your accuracy in selecting the explanation of the word, continuous study. And also, the word number that you recite each day.
   ...
   Collection button will direct to the collected word list. And in that page you could find the words in your collection list, and there also have one subsection of the page for you to review.
...
3. Setting: Divided into two parts: Study and General
   ...
   In study section, you could personalize your choice on how many words that you want to recite or review. Also, the pronunciation mode, word order and the study order of words could be selected.

   In general display section, you could change the display scale and choose the background display mode. Also, the progress data could be cleared out if the user wish to start again.
